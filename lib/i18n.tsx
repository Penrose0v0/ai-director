...
const zh = {
  ...
  "video.upload": "上传",
  "video.empty": "还没有视频 · 生成 / 加载 sample / 上传",
  "video.generate": "✨ 生成视频",
  "video.generating": "生成中…（约 1–2 分钟）",
  "video.review": "导演审查",
  "video.reviewing": "审查中…",
  "video.needVideo": "先生成或加载视频再审查",
  ...
  "review.colStatus": "状态",
  "review.suggestHeading": "修改建议（可直接应用到分镜）",
  "review.apply": "应用到分镜",
  "review.applied": "已应用 ✓",
  "review.applyAll": "全部应用",
  "review.noSuggest": "没有可应用的结构化建议。",
  "review.fixTitle": "修复 Prompt（用于重新生成）",
...
const ja: Dict = {
  ...
  "video.upload": "アップロード",
  "video.empty": "動画なし · 生成 / サンプル / アップロード",
  "video.generate": "✨ 動画を生成",
  "video.generating": "生成中…（約 1〜2 分）",
  "video.review": "ディレクターレビュー",
  "video.reviewing": "レビュー中…",
  "video.needVideo": "先に動画を生成または読み込んでください",
  ...
  "review.colStatus": "状態",
  "review.suggestHeading": "修正提案（ショットに直接適用）",
  "review.apply": "ショットに適用",
  "review.applied": "適用済み ✓",
  "review.applyAll": "すべて適用",
  "review.noSuggest": "適用できる構造化提案はありません。",
  "review.fixTitle": "修正プロンプト（再生成用）",
...
const en: Dict = {
  ...
  "video.upload": "Upload",
  "video.empty": "No video yet · generate / sample / upload",
  "video.generate": "✨ Generate video",
  "video.generating": "Generating… (~1–2 min)",
  "video.review": "Director Review",
  "video.reviewing": "Reviewing…",
  "video.needVideo": "Generate or load a video before reviewing",
  ...
  "review.suggestHeading": "Suggested edits (apply straight to the shot)",
  "review.apply": "Apply to shot",
  "review.applied": "Applied ✓",
  "review.applyAll": "Apply all",
  "review.noSuggest": "No structured suggestions to apply.",
  "review.fixTitle": "Fix Prompt (for regeneration)",
